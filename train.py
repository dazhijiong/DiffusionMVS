...
def main(gpu, args, config):
    ...
    for dl_params in config['data_loader']:
        ...
        print("train_dl_args['batch_size']",train_dl_args['batch_size'])
        train_loader = DataLoader(train_dataset, shuffle=False, pin_memory=False, batch_size=train_dl_args['batch_size'],
        ...
        val_data_loader = DataLoader(val_dataset, shuffle=False, pin_memory=False, batch_size=train_dl_args['batch_size'],
